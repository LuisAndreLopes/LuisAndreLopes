window.onload = function(){
    this.document.getElementById('btn-quiz').onclick = Quiz;
    };
         function Quiz(){
          getElementById('btn-quiz').onclick = Quiz;
          ...
          // LISTA DE PERGUNTAS
          p[1] = "O que e Feras ? \n 1: Varios animais \n 2: Féras e o novo top. Programa de Reconhecimento Mensal de Acordo com o Kpi.";
          r[1] = 2;
          ...
          /*p[7] = " \n 1: ";
          r[7] = 2;
          p[8] = "Qual deve ser a medida do ngulo de um triangulo equil�tero?";
          r[8] = 60;
          ...
          for(var i=1;i<=t;i++)
           { document.write("<li>"+p[o[i]]+"<br><b style='color:blue;'>Resposta:</br>"+r[o[i]])};}
